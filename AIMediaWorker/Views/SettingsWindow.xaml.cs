...
public sealed partial class SettingsWindow : Window
{
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        LanguageCombo.SelectedItem = _settings.General.Language; ThemeCombo.SelectedItem = _settings.General.Theme; UiFontText.Text = _settings.General.UiFontFamily; RecentCountBox.Value = _settings.General.RecentMediaCount; ResumeCheck.IsChecked = _settings.General.ResumePlayback; DefaultFolderBox.Text = _settings.General.DefaultFolder ?? string.Empty;
    ...
    private async void OnFontFlyoutOpening(object sender, object e)
    {
        ...
        var selectedFont = isUiFont ? UiFontText.Text : SubtitleFontText.Text;
        if (string.IsNullOrWhiteSpace(selectedFont))
            selectedFont = isUiFont ? GeneralSettings.DefaultUiFontFamily : SubtitleSettings.DefaultFontFamily;
    ...
    private void OnFontListSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            UiFontText.Text = selectedFont;
            UiFontFlyout.Hide();
        }
        else
        {
            SubtitleFontText.Text = selectedFont;
    ...
    private async void OnSaveClick(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            _settings.General.Language = (AppLanguage)(LanguageCombo.SelectedItem ?? AppLanguage.Default); _settings.General.Theme = (AppTheme)(ThemeCombo.SelectedItem ?? AppTheme.System); _settings.General.UiFontFamily = string.IsNullOrWhiteSpace(UiFontText.Text) ? GeneralSettings.DefaultUiFontFamily : UiFontText.Text; _settings.General.RecentMediaCount = (int)RecentCountBox.Value; _settings.General.ResumePlayback = ResumeCheck.IsChecked == true; _settings.General.DefaultFolder = EmptyToNull(DefaultFolderBox.Text);
